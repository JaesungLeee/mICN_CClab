...
import kotlinx.android.synthetic.main.activity_server3_contents.*

class server3Contents : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_server3_contents)
    ...
    private fun buttonClickListner() {
        s3c1Download_btn.setOnClickListener {
            url = "https://conferences.sigcomm.org/co-next/2009/papers/Jacobson.pdf"
            checkVersion(url)
        }

        s3c2Download_btn.setOnClickListener {
